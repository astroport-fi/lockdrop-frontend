...
export interface UserInfoResponse {
  /**
   * APOLLO tokens transferred to user
   */
  apollo_tokens_transferred: Uint128;
  /**
   * Lockup positions
   */
  ...
  /**
   * Total APOLLO tokens user received as rewards for participation in the lockdrop
   */
  total_apollo_rewards: Uint128;
  [k: string]: unknown;
}
