        ...
        <AccordionPanel>
          <Box px={["6", null, null, "12"]}>
            ...
            <Box pt="8" pb="12">
                  ...
                  >
                    <VStack flex="1" spacing={["2", null, "6"]}>
                      ...
                      >
                        ...
                        transferrable upon Astroport’s launch or can be used in
                        Phase 2 to earn even more ASTRO tokens
                      </Text>
                    </VStack>
              ...
              <Box w={["100%", null, null, "70%", "50%"]}>
                <Text variant="content">
                  The more liquidity you lock and the longer you lock for, the
                  more ASTRO you will receive. Be aware that certain pools
                  receive a higher amount of ASTRO than others.
                </Text>
              </Box>
              <Heading
                as="h2"
                ...
                >
                  ...
                  >
                    ...
                    <HStack
                      ...
                      fontWeight="700"
                    >
                      <Flex justify="center" align="center" bg="white" flex="1">
                        1
                      </Flex>
                      <Flex justify="center" align="center" bg="white" flex="1">
                        2
                ...
                >
                  ...
                  >
                    <Box>
                      ...
                      <Text variant="content">
                        Users can deposit their liquidity at any time during the
                        first 5 days of Phase 1, and the time of the deposit
                        will not impact the amount of ASTRO received (e.g. a
                        deposit on Day 1 is the same as a deposit on Day 5).
                        Each user’s share of ASTRO rewards is calculated pro
                        rata based on the amount of liquidity provided in each
                        pool at the time of the snapshot at the end of Phase 1.
                        The more liquidity provided and the longer it’s locked
                    ...
                    <Box>
                      ...
                      <Text variant="content">
                        You can unlock your locked LP positions at any time once
                        Astroport is live, but if you unlock prematurely you
                        have to return all your ASTRO rewards.
                      </Text>
                    </Box>
                  </VStack>
                </Box>
                ...
                >
                  ...
                  <Box width={["100%", null, "120%"]} mt={["8", null, "4"]}>
                    <UnorderedList variant="content">
                      <ListItem>From day 6 on, deposits are closed. </ListItem>
                      <ListItem>
                      ...
                      <ListItem>
                        ...
                        decreases linearly, starting at 50% and decreasing to 0%
                        at the end of the lockdrop.
                      </ListItem>
                      <ListItem>
