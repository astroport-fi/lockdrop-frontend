      ...
      <Card>
        ...
        >
          <VStack spacing="6" align="flex-start" width={["100%", null, "45%"]}>
            ...
            <Text fontSize="14px">
              The Journey to Astroport starts now and we want you to get
              onboard. Your courage will be rewarded with Astroport governance
              tokens and power over the fate of the ship. Our voyage is
              separated into 3 different phases. Join below or{" "}
              <NextLink href="#" passHref>
                <Link color="#83B3FD">fly here</Link>
              </NextLink>{" "}
              to learn more about Astroport.
            </Text>
            <NextLink href="/phase-2" passHref>
