...
const defaultContracts: { [key: string]: any } = {
  ...
  testnet: {
    ...
    lockdrop: "terra1fpmrk6e63l6tg0j87566ajhzwdz6vddv4ndy7l",
    airdrop: "terra1r2z7hnwpt6aeepxtvg8acayaykdy3cdkqakekt",
    auction: "terra1hvmuhr4ujffna8u2lle9w38k8hsd86fftgkxrr",
    pairs: [
      {
