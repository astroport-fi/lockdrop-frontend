...
const defaultContracts: { [key: string]: any } = {
  ...
  testnet: {
    ...
    lockdrop: "terra1dccmmr6h23sdd7vfh0kkeh3x5z32lwvz04v8m9",
    airdrop: "terra1w80t3qtzlppznqu0qzzv5e4lehp0hr2wp6qhpp",
    auction: "terra1y07qgyf8x799f8x6qxpmmvkjy5ljgux3xyfzfd",
    pairs: [
      {
