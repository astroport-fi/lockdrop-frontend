...
const defaultContracts: { [key: string]: any } = {
  ...
  testnet: {
    ...
    lockdrop: "terra1rvs0my78qp3afyz2wajhmyltts6072a5ez4lh6",
    airdrop: "terra1d0npukutue66xssvfclqfhtf0mavpqul9q9lr7",
    auction: "terra1dd4740s2hsgp2enlk4j96z2j9den5q3xremnnu",
    pairs: [
      {
