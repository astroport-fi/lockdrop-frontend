...
const defaultContracts: { [key: string]: any } = {
  ...
  testnet: {
    ...
    lockdrop: "terra1p27ajchvxh2f4zmlfmcnxqhpxxtc7y5ksk709e",
    airdrop: "terra1rnt3f764kfq929wzxerg5ms02hhjumvcggdx66",
    auction: "terra1e4d6qt6uj9r8e85uy57d48rs2m4xztxjhug00z",
    pairs: [
      {
