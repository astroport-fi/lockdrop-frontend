...
const defaultContracts: { [key: string]: any } = {
  ...
  testnet: {
    ...
    lockdrop: "terra1ddmgr5j4udxccc3sy2qntcpas5mtv4nqacasrw",
    airdrop: "terra14lclq7pqtwfsurjn477lxnwyqx47k8wmykfzwj",
    auction: "terra1eaffun720j6x4kp8xnn97d8kft5yuknes34yhl",
    pairs: [
      {
