...
const defaultContracts: { [key: string]: any } = {
  ...
  testnet: {
    ...
    lockdrop: "terra15824k9ttre6znzwu0ydwfd7ay7umuf2wyxlh80",
    airdrop: "terra1arfmarlav8m4uslhgetantjqpxtjwmvhz0hj8w",
    auction: "terra1qdtn4xw0rznmp9nkkzae087d5lme5lc8tqgd2x",
    pairs: [
      {
