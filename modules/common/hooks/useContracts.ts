...
const defaultContracts: { [key: string]: any } = {
  ...
  testnet: {
    ...
    lockdrop: "terra1mmknjaax8tyhlmrpd9tse9svy280aes9uj2stz",
    airdrop: "terra1dd94rddk4djxg0eyt9mld8z2nee5d5ula04emk",
    auction: "terra1etm6zs2w8vvy805ga5yrt8x9w5h0krucsc5mch",
    pairs: [
      {
